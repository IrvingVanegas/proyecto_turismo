...
class _AgregarHotel extends State<AgregarHotel>{
  ...
  Object CatselectedValue = "Simple";
  List<DropdownMenuItem<String>> get CatdropdownItems{
    const List<DropdownMenuItem<String>> menuItems = [
      ...
      DropdownMenuItem(child: Text("Precidencial"),         value: "Precidencial"),

    ];
    return menuItems;
  }

  Object TipoHabselectedValue = "Individual";
  ...
  bool _verifyData(nombre,descripcion,costo,numeroHab,numeroExt,calle,
    ...
    codigoPostal == ''){
      _alert('Campos sin llenar',context);
      return false;
    }else return true;
  }
